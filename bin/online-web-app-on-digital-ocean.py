...
def main():
    ...
    draw.text(
        text="Your first Web application in the\n\nDigital Ocean Cloud (Hebrew)",
        xy=(250, 130),
        fill=(0, 0, 0),
        font=font_title,
    )
    ...
    embed_image(img=img, filename='digital-ocean-icon-blue.png', box=(30, 30), mask=True)
    embed_image(img=img, filename='python.png', box=(400, 450), mask=True)
