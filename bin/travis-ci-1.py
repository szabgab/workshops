...
def main():
    ...
    draw.text(
        text = "Continous Integration in the Cloud",
        xy   = (250, 130),
        fill = (0, 0, 0),
        font = font_title2,
    )
    ...
    embed_image(img=img, filename='tessa.png', box=(10, 20), mask=True)
