...
def main():
    ...
    add_text(
        draw = draw,
        text = "Oz Mendelsohn      Gábor Szabó",
        rtl  = False,
        size = 80,
        xy   = (30, 420),
    )

    embed_image(img=img, filename='oz_mendelshon.jpeg',   size=(200, 200), box=(10, 500))
