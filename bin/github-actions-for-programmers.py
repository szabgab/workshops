...
def create_thumbnail(show=False):
    ...
    add_text(
        draw = draw,
        text = "GitHub Actions for programmers",
        rtl  = False,
        size = 70,
        xy   = (20, 20),
    )
    ...
    add_text(
        draw = draw,
        text = f"- CI - Continous Integration",
        rtl  = False,
        size = 50,
        xy   = (20, 180),
    )
    ...
    add_text(
        draw = draw,
        text = f"- Quick feedback on your changes",
        rtl  = False,
        size = 50,
        xy   = (20, 250),
    )
    ...
    add_text(
        draw = draw,
        text = f"- Linux, macOS, Windows, Docker",
        rtl  = False,
        size = 50,
        xy   = (20, 320),
    )
    ...
    add_text(
        draw = draw,
        text = f"A training course by Gábor Szabó",
        rtl  = False,
        size = 35,
        xy   = (280, height-120),
    )
