...
def main():
    ...
    add_text(
        draw = draw,
        text = heb("אם כל אחד יכול לשנות קוד פתוח"),
        rtl  = True,
        size = 65,
        xy   = (1250, 30),
    )
    ...
    add_text(
        draw = draw,
        text = heb("אז איך אפשר לסמוך על זה?"),
        rtl  = True,
        size = 65,
        xy   = (1250, 180),
    )
    ...
    add_text(
        draw = draw,
        text = "If anyone can change open source code",
        rtl  = False,
        size = 64,
        xy   = (20, 420),
    )
    ...
    #embed_image(img=img, filename='flask.png', size=(isize, isize), box=(10, 10), mask=True)
