...
def main():
    ...
    embed_image(img=img, filename='github-octocat.png', size=(200, 200), box=(10, 210), mask=True)
    embed_image(img=img, filename='git-logo-512x214.png', size=(200, 200), box=(10, 30), mask=True)
