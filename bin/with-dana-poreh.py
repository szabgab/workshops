...
def main():
    ...
    add_text(
        draw = draw,
        text = "שכרגע גם בעצמה מחפשת עבודה",
        rtl  = True,
        xy   = (950, 330),
        size = 60,
    )
    ...
    embed_image(img=img, filename='dana-poreh.jpeg', size=(isize, isize), box=(10, height-isize-10))
