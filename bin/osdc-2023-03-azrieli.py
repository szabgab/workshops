...
def main():
    ...
    #for episode in ['1-1', '1-2']: #range(1, end+1):
    #for episode in ['2-1', '2-2']: #range(1, end+1):
    #for episode in ['3-1']: #range(1, end+1):
    #for episode in ['4-1']: #range(1, end+1):
    #for episode in ['5-1', '5-2']: #range(1, end+1):
    #for episode in ['6-1', '6-2']: #range(1, end+1):
    #for episode in ['7-1', '7-2']: #range(1, end+1):
    #for episode in ['8-1', '8-2']: #range(1, end+1):
    #for episode in ['9-1', '9-2']: #range(1, end+1):
    #for episode in ['10-1', '10-2']: #range(1, end+1):
    #for episode in ['11-1', '11-2']: #range(1, end+1):
    #for episode in ['12-1', '12-2']: #range(1, end+1):
    for episode in ['13-1', '13-2']: #range(1, end+1):
...
#    )
    ...
    add_text(
        draw = draw,
        text = f"Azrieli College - Part {episode}",
        rtl  = False,
        size = 70,
        xy   = (50, 560),
    )
