...
def main():
    ...
    embed_image(img=img, filename='michal-mironi-logo.png', size=(isize, isize), box=(10, 20), mask=False)
    embed_image(img=img, filename='michal-mironi.jpeg', size=(isize, isize), box=(10, height-isize-10))
