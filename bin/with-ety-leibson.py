...
def main():
    ...
    add_text(
        draw = draw,
        text = "קישורים וכישורים - יעוץ קריירה",
        rtl  = True,
        xy   = (950, 290),
        size = 60,
    )
    ...
    embed_image(img=img, filename='ety-leibson-logo.jpeg', box=(10, 20), mask=False)
    embed_image(img=img, filename='ety-leibson.jpeg', size=(isize, isize), box=(10, height-isize-10))
