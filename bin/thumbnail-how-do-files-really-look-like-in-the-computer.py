...
#    )
    ...
    embed_image(img=img, filename='code_maven_440x440.png', size=(isize, isize), box=(10, height-isize-10), mask=True)
#    embed_image(img=img, filename='dev_to.png', size=(isize, isize), box=(10, 400), mask=False)
