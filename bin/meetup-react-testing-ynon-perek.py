...
def main():
    ...
    add_text(
        draw = draw,
        text = "Front End Testing of Kutt",
        rtl  = False,
        xy   = (20, 30),
        size = 60,
    )
    ...
    add_text(
        draw = draw,
        text = "using the React testing library",
        rtl  = False,
        xy   = (20, 140),
        size = 60,
    )
    ...
    add_text(
        draw = draw,
        text = "With Ynon Perek of ToCode.co.il",
        rtl  = False,
        xy   = (20, 250),
        size = 60,
    )
...
#
    ...
    embed_image(img=img, filename='ynon_perek.jpeg', size=(isize, isize), box=(10, height-isize-10))
