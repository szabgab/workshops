...
def main():
    ...
    add_text(
        draw = draw,
        text = "Python s3path, the pathlib",
        rtl  = False,
        size = 80,
        xy   = (200, 30),
    )
...
#    )
    ...
    embed_image(img=img, filename='lior_mizrahi.jpeg',   size=(200, 200), box=(10, 500))
